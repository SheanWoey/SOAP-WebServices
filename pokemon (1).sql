...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2018 at 02:18 AM
...
CREATE TABLE `pokemon_species` (
  ...
  `SpAtk` int(3) DEFAULT NULL,
  `SpDef` int(3) DEFAULT NULL,
...
INSERT INTO `pokemon_species` (`ID`, `Name`, `Type1`, `Type2`, `Total`, `HP`, `Attack`, `Defense`, `SpAtk`, `SpDef`, `Speed`, `Generation`, `Legendary`) VALUES
(0, 'Name', 'Type 1', 'Type 2', 0, 0, 0, 0, 0, 0, 0, 0, 'Legen'),
...
(669, 'Flab??b??', 'Fairy', '', 303, 44, 38, 39, 61, 79, 42, 6, 'FALSE'),
